      ...
      <div className=" font-normal">
        {content.map((item, i) => (
          <div key={i} className={item.class}>
            <button
              type="button"
              className={`py-4 w-full flex items-center text-[13px] leading-[30px] text-primary `}
            ...
            <div>
              ...
              >
                <div className="space-y-2 p-4 text-[13px] leading-[30px] border-t border-secondary text-primary">
